...
def expand_source_to_target(rows, columns, layer1_grid,layer2_grid, source, target,bend_penalty,via_penalty,layer2_enable):
    wavefront = {}
    visited = set()
    parents = {}
...
def true_two_layer_router(rows, columns, layer1_grid,layer2_grid, nets,bend_penalty,via_penalty,layer2_enable):
    routing_table = {}
    costs_table = {}
    cnt = 0
    for net in nets:
    ...
    for net in nets:
        ...
        path,costs = expand_source_to_target(rows, columns, layer1_grid,layer2_grid, pin1, pin2,bend_penalty,via_penalty,layer2_enable) 
        if path is not None:
...
if __name__ == "__main__":
    ...
    routing_table,costs_table=true_two_layer_router(rows, columns, layer1_grid.T,layer2_grid.T, nets,bend_penalty,via_penalty,layer2_enable)
